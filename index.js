...
const languages = [
  ...
  {name:'Matplotlib', file:'plot.py', href:'lessons/matplotlib.html', accent:'--matplotlib-a', desc:'Python · data visualization · charts', cmt:'#', lessons:30, emoji:'📈', curriculum:['Introduction to Matplotlib','Common Matplotlib Charts','Plot Customization & Styling','Matplotlib with NumPy & Pandas','Capstone: Complete Data Visualization System']},
